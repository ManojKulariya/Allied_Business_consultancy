        ...
        <section class="flat-spacing-10">
            <div class="container">
                <div class="form-register-wrap">
                    ...
                    <div>
                        <form class="" id="register-form" action="{{ route('users.register') }}" method="post" accept-charset="utf-8" data-mailchimp="true">
                            @csrf
                            ...
                            <div class="text-center">
                                <a href="{{ route('users.login') }}" class="tf-btn btn-line">Already have an account? Log in here<i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </form>
                    </div>
                </div>
