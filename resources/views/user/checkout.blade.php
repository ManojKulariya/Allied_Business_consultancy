                            ...
                            <fieldset class="box fieldset">
                                ...
                                <div class="select-custom">
                                    <select class="tf-select w-100" id="country" name="address[country]" data-default="">
                                        <option value="---" data-provinces="[]" selected="selected">---</option>
                            ...
                            <form class="tf-page-cart-checkout widget-wrap-checkout">
                                <ul class="wrap-checkout-product">
                                    <li class="checkout-product-item">
                                        <figure class="img-product">
                                            <img src="{{ asset('frontend/img/shop/brown.jpg')}}" alt="product">
                                    ...
                                    <li class="checkout-product-item">
                                        <figure class="img-product">
                                            <img src="{{ asset('frontend/img/shop/kid-12.jpg')}}" alt="product">
                                            <span class="quantity">1</span>
                                        </figure>
                                        <div class="content">
                                            <div class="info">
                                    ...
                                    <li class="checkout-product-item">
                                        <figure class="img-product">
                                            <img src="{{ asset('frontend/img/shop/beige-2.jpg')}}" alt="product">
                                            <span class="quantity">1</span>
                                        </figure>
                                        <div class="content">
                                            <div class="info">
                                    ...
                                    <li class="checkout-product-item">
                                        <figure class="img-product">
                                            <img src="{{ asset('frontend/img/shop/orange-1.jpg')}}" alt="product">
                                ...
                                <div class="wd-check-payment">
                                    <div class="fieldset-radio mb_20">
                                        <input type="radio" name="payment" id="bank" class="tf-check" checked="checked">
                                    ...
                                    <p class="text_black-2 mb_20">Your personal data will be used to process your order,
                                        ...
                                        described in our <a href="https://themesflat.co/html/ecomus/privacy-policy.html" class="text-decoration-underline">privacy policy</a>.</p>
                                    <div class="box-checkbox fieldset-radio mb_20">
                                        ...
                                        <label for="check-agree" class="text_black-2">I have read and agree to the
                                            website <a href="https://themesflat.co/html/ecomus/terms-conditions.html" class="text-decoration-underline">terms and conditions</a>.</label>
                                    </div>
                                </div>
