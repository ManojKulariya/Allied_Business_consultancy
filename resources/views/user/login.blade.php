                ...
                <div class="tf-grid-layout lg-col-2 tf-login-wrap">
                    <div class="tf-login-form">
                        <div id="recover">
                            ...
                            <div>
                                <form class="" id="login-form" action="{{ route('users.login') }}" method="post" accept-charset="utf-8" data-mailchimp="true">
                                    @csrf
                                    ...
                                    <div class="">
                                        <button type="submit" class="tf-btn w-100 radius-3 btn-fill animate-hover-btn justify-content-center">Reset
                                            password</button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div id="login">
                            ...
                            <div>
                                <form class="" id="login-form" action="{{ route('users.login') }}" method="POST" accept-charset="utf-8">
                                    @csrf
                                    <div class="tf-field style-1 mb_15">
                                        <input class="tf-field-input tf-input" placeholder="" type="email" id="property3" name="email">
                                        <label class="tf-field-label fw-4 text_black-2" for="property3">Email *</label>
                                    ...
                                    <div class="mb_20">
                                        <a href="{{ route('users.password.request') }}" class="tf-btn btn-line">Forgot your password?</a>
                                    </div>
                                    <div class="">
                                        <button type="submit" class="tf-btn w-100 radius-3 btn-fill animate-hover-btn justify-content-center">Log
                                            in</button>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="tf-login-content">
                        ...
                        <a href="{{ route('users.register') }}" class="tf-btn btn-line">Register<i class="icon icon-arrow1-top-left"></i></a>
                    </div>
                </div>
            </div>
        </section>
