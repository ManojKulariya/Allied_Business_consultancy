    ...
    public function run(): void
    {
        $sections = [
            [
                ...
                'content' => '<p>Allied Business Consultancy is a single point of contact for company registration, taxation, GST and compliance — helping entrepreneurs start, manage, protect and grow their businesses with transparent, expert guidance.</p>',
            ...
            [
                ...
                'content' => '<p>Allied Business Consultancy is a single point of contact for taxation, accounting and compliance — serving startups, MSMEs, traders and private limited companies across Rajasthan and Delhi NCR with practical, transparent advisory.</p>',
                'cta_text' => 'More About Us',
                'cta_url' => '/about-us',
                'data' => [
                    'mission' => 'To simplify compliance and taxation for every business we work with, so founders can focus on running their business — not chasing paperwork.',
                    'vision' => 'To be the most trusted business consultancy for entrepreneurs and growing companies across Rajasthan and Delhi NCR.',
                    'experience_value' => '15+',
                    'experience_label' => 'Years Experience',
                    'features' => 'Certified Chartered Accountants, Transparent Fixed Pricing, Complete Confidentiality, Single Point of Contact',
                    'signature_name' => null,
